      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center w-full" style={{ marginLeft: '100px' }}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-20 lg:mb-28 mt-16 lg:mt-20 max-w-4xl mx-auto w-full place-items-center">
              ...
              <motion.div variants={itemVariants} className="flex justify-center w-full">
                <Card className="h-full p-8 lg:p-10 text-center w-full max-w-sm">
                  ...
                  <div className="space-y-6 text-text-secondary leading-relaxed text-base lg:text-lg text-center" style={{textAlign: 'center', marginTop: '50px'}}>
                  <p>
            ...
            <motion.div variants={itemVariants} className="flex justify-center w-full">
              <Card className="h-full p-8 lg:p-10 text-center w-full max-w-sm">
                <h3 className="text-2xl lg:text-3xl font-bold text-text-primary mb-8 text-center" style={{marginTop: '-90px'}}>
                  Beyond the Code
                </h3>
                <div className="space-y-6 text-text-secondary leading-relaxed text-base lg:text-lg text-center" style={{textAlign: 'center', marginTop: '50px'}}>
                  <p>
