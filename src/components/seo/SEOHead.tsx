...
export const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  return (
    <Head>
      ...
      <meta property="og:type" content={metaTags.openGraph?.type as string} />
      ...
      {/* Twitter */}
      <meta name="twitter:card" content={metaTags.twitter?.card as string} />
      <meta name="twitter:title" content={metaTags.twitter?.title as string} />
      <meta name="twitter:description" content={metaTags.twitter?.description as string} />
      {image && <meta name="twitter:image" content={image} />}
      
      {/* Additional SEO Tags */}
      <meta name="author" content={metaTags.authors?.[0]?.name as string} />
